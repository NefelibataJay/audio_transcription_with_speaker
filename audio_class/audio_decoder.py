...
class Decoder:
    ...
    def run(self, wav_file):
        ...
        speaker_identification_thread = SpeakerIdentificationThread(
            self.speaker_identifier, self.si_data_queue, self.si_result_queue)
            ...
            for start, end in segments_result:
                ...
                if end != -1:
                    ...
                    if end_ms - start_ms > 800:
                        ...
                        asr_offline_final = self.second_pass_decoder.infer_offline(
                            data, hot_words=' '.join(self.keywords))
                        _final = self.punctuator.punctuate(
                            asr_offline_final)[0]
                        print(_final)
